            ...
            <?php //if( $step_settings > 2 ): ?>
                ...
                <div class="swcfpc_tab <?php if($tab_active == "cache") echo 'active'; ?>" id="cache">
                    ...
                    <div class="main_section">
                        <div class="left_column">
                            ...
                            <div class="description"><?php _e('Purge only the cached HTML pages instead of the whole Cloudflare cache (assets + pages).', 'wp-cloudflare-page-cache'); ?></div>
                        </div>
                        <div class="right_column">
                    ...
                    <div class="main_section cfworker">
                        <div class="left_column">
                            <label><?php _e('Disable the cache buster', 'wp-cloudflare-page-cache'); ?></label>
                            <div class="description"><?php printf( __('To allow you to bypass the Cloudflare cache while logged in, the plugin automatically adds the %s parameter on all internal links, only while you are logged in. If you have enabled the Worker mode, you can disable this feature.', 'wp-cloudflare-page-cache'), SWCFPC_CACHE_BUSTER); ?></div>
                        </div>
                        <div class="right_column">
                            <div class="switch-field">
                                <input type="radio" id="switch_<?php echo ++$switch_counter; ?>_left" name="swcfpc_cf_disable_cache_buster" value="1" <?php if( $this->main_instance->get_single_config("cf_disable_cache_buster", 0) > 0 ) echo "checked";  ?>/>
                                <label for="switch_<?php echo $switch_counter; ?>_left"><?php _e("Yes", 'wp-cloudflare-page-cache'); ?></label>
                                <input type="radio" id="switch_<?php echo $switch_counter; ?>_right" name="swcfpc_cf_disable_cache_buster" value="0" <?php if( $this->main_instance->get_single_config("cf_disable_cache_buster", 0) <= 0 ) echo "checked";  ?> />
                                <label for="switch_<?php echo $switch_counter; ?>_right"><?php _e("No", 'wp-cloudflare-page-cache'); ?></label>
                            </div>
                        </div>
                        <div class="clear"></div>
                ...
                <div class="swcfpc_tab <?php if($tab_active == "advanced") echo 'active'; ?>" id="advanced">
                    ...
                    <div class="main_section preloader">
                        ...
                        <div class="right_column">
                            ...
                            <p><b><?php echo $preloader_cronjob_url; ?></b></p>
                        </div>
                        <div class="clear"></div>
                    </div>
                ...
                <div class="swcfpc_tab <?php if($tab_active == "thirdparty") echo 'active'; ?>" id="thirdparty">
                    ...
                    <div class="main_section">
                        ...
                        <div class="right_column">
                            <div><input type="checkbox" name="swcfpc_cf_wp_rocket_purge_on_domain_flush" value="1" <?php echo $this->main_instance->get_single_config("cf_wp_rocket_purge_on_post_flush", 0) > 0 ? "checked" : ""; ?> /> <?php _e('WP Rocket flushs all caches', 'wp-cloudflare-page-cache'); ?> - <strong><?php _e('(recommended)', 'wp-cloudflare-page-cache'); ?></strong></div>
                            <div><input type="checkbox" name="swcfpc_cf_wp_rocket_purge_on_post_flush" value="1" <?php echo $this->main_instance->get_single_config("cf_wp_rocket_purge_on_domain_flush", 0) > 0 ? "checked" : ""; ?> /> <?php _e('WP Rocket flushs single post cache', 'wp-cloudflare-page-cache'); ?> - <strong><?php _e('(recommended)', 'wp-cloudflare-page-cache'); ?></strong></div>
                ...
                <div class="swcfpc_tab <?php if($tab_active == "faq") echo 'active'; ?>" id="faq">
                    ...
                    <div class="swcfpc_faq_accordion">
                        ...
                        <div class="swcfpc_faq_answer">
                            ...
                            <p><?php _e('It is added to all internal links for logged in users only. You can disable it if you enable the Worker mode.', 'wp-cloudflare-page-cache'); ?></p>
                    ...
                    <div class="swcfpc_faq_accordion">
                        ...
                        <div class="swcfpc_faq_answer">
                            ...
                            <p><?php _e('If this happened on your site, enable the <strong>SEO redirect</strong> inside the plugin settings page under the <strong>Others</strong> tab. This will auto redirect any URLs which has <i>swcfpc=1</i> in it to it\'s normal URL when any non-logged in user clicks on that link, avoiding duplicate content problems.', 'wp-cloudflare-page-cache'); ?></p>
