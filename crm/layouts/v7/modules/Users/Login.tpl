...
{strip}
	<style>
		body {
			background: url(layouts/v7/resources/Images/praia-grande-sp-3.jpg);
	...
	<div class="col-lg-12">
		<div class="col-lg-12">
			<div class="loginDiv widgetHeight">
				<img class="img-responsive user-logo" src="layouts/v7/customlogin/images/logo.png">
				<div>
				...
				<div id="forgotPasswordDiv" class="hide">
					<form class="form-horizontal" action="forgotPassword.php" method="POST">
						...
						<div class="group">
							...
							<span>Digite os detalhes e envie<a class="forgotPasswordLink pull-right" style="color: #15c;">Voltar</a></span>
						</div>
					</form>
				</div>
			</div>
