...
<h3 style="color:#f1f1f1; font-size:24px;">Consors - Para Vender seu Consórcio, Preencha o Formulário Abaixo</h3>
<ul itemprop="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
<a itemprop="item" href="<?php echo HTTP_HOST; ?>" title="Home"><span itemprop="name"><?php echo get_bloginfo('name');?></span></a>
...
<p class="conteudo"><?php echo $semantica_7;?></p>
</div></div></div></section>
<!-- =================Career Details ============ -->
...
<h1 itemprop="serviceType">Como Vender Consórcio</h1>
...
<meta itemprop="name" content="Para Vender seu Consórcio, Preencha o Formulário Abaixo">
<meta itemprop="height" content="250">
<meta itemprop="width" content="1000">
<meta itemprop="url" content="<?php echo get_template_directory_uri(); ?>/datafiles/servicos/como-vender-consorcio-capa.jpg">
<img src="<?php echo get_template_directory_uri(); ?>/datafiles/servicos/como-vender-consorcio-capa.jpg" alt="Para Vender seu Consórcio, Preencha o Formulário Abaixo" hspace="1" vspace="10" align="left">
</div>
<div style="clear:both"></div>
<div itemprop="description">
                        
<p>Quer saber como vender consórcio com segurança e com uma avaliação justa? Conheça a Consors e peça uma avaliação para comprar sua cota de consórcio. Não venda antes de consultar nossa empresa</p>
...
<p class="conteudo"><?php echo $semantica_4;?></p>
</div>
<!-- === Fim Formulário === -->				
</div>
</div>
