...
<h3 style="color:#f1f1f1; font-size:24px;">Consors - Compramos seu Consórcio</h3>
...
<h1 itemprop="serviceType">Compramos Consórcio</h1>
...
<meta itemprop="name" content="Compramos seu Consórcio">
<meta itemprop="height" content="250">
<meta itemprop="width" content="1000">
<meta itemprop="url" content="<?php echo get_template_directory_uri(); ?>/datafiles/servicos/compramos-consorcio-capa.jpg">
<img src="<?php echo get_template_directory_uri(); ?>/datafiles/servicos/compramos-consorcio-capa.jpg" alt="Compramos seu Consórcio" hspace="1" vspace="10" align="left">
</div>
<div style="clear:both"></div>
<div itemprop="description">
                        
<p>Compramos Consórcio de todas as administradoras do Brasil pagando um preço justo. Não venda seu consórcio antes de solicitar uma avaliação da Consors. Aqui você receberá um preço justo. Compramos seu consórcio sem intermediadores, e com isso não precisamos pagar comissões, o que resulta em uma oferta mais lucrativa para você</p>
...
<h6>Compramos seu Consórcio</h6><p style="font-size:15px;color:#000;margin-top:15px"><strong>1 - TEMOS A MELHOR AVALIAÇÃO. ENTENDA</strong></p><p style="padding-right:30px;color:#666"><strong style="color:#12a0b1">Não temos intermediação</strong>, compramos nossas cotas <strong style="color:#12a0b1">diretamente de nossos clientes</strong>, o que nos possibilita oferecer as melhores avaliações de mercado.</p><p class="conteudo"><?php echo $semantica_11;?></p><p style="padding-right:30px;color:#666"><strong>Preencha o Formulário, para vender o seu consórcio</strong>. Iremos avaliar as informações e retornaremos a seguir com um proposta para comprar seu consórcio. </p>
