...
if($id){
  ...
  $nm_miniatura = $obj[0]->nm_miniatura;
...
<div class="form-group">
  ...
  <div class="col-lg-2">
    <input type="text" class="form-control" name="nm_foto[]" id="nm_foto<?php echo $rand;?>" placeholder="Imagem" value="<?php echo $nm_foto;?>">
  ...
  <label class="col-lg-1 control-label">Miniatura</label>
  <div class="col-lg-2">
    <input type="text" class="form-control" name="nm_miniatura[]" id="nm_miniatura<?php echo $rand;?>" placeholder="Miniatura" value="<?php echo $nm_miniatura;?>">
  </div>
  <div style="float:left;">
    <a href="../tinymce/upload/index.php" rel="shadowbox[Mixed1];width=1024;height=600" onClick="setMyField('nm_miniatura<?php echo $rand;?>');"><img src="../img/icons/file_add.png" title="Adicionar Miniatura" class="add ui-corner-left" border="0" height="30" /></a>
  </div>

  <label class="col-lg-1 control-label">Legenda</label>
  <div class="col-lg-2">
