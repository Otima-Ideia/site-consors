                    ...
                    function (data) {
                        ...
                        try
                        {
                            if (widgetName != "php") {
                                ...
                                var frame = '<iframe frameborder="0" src="' + apiURL + '" id="widgetAPI" style="height: ' + parseInt(demoHeight) + 'px; border-collapse: collapse; margin-left: 10px; width: 700px;"></iframe>';
                                $('#tabs-3').html(frame)
                            }
                        }
                        catch (error) {
