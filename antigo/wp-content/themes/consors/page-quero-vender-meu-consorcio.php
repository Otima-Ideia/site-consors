...
<h3 style="color:#f1f1f1; font-size:24px;">Consors - Quer Vender seu Consórcio? Escolha a Consors</h3>
...
<h1 itemprop="serviceType">Quero vender meu consórcio</h1>
...
<meta itemprop="name" content="Quer Vender seu Consórcio? Escolha a Consors">
<meta itemprop="height" content="250">
<meta itemprop="width" content="1000">
<meta itemprop="url" content="<?php echo get_template_directory_uri(); ?>/datafiles/servicos/quero-vender-meu-consorcio-capa.jpg">
<img src="<?php echo get_template_directory_uri(); ?>/datafiles/servicos/quero-vender-meu-consorcio-capa.jpg" alt="Quer Vender seu Consórcio? Escolha a Consors" hspace="1" vspace="10" align="left">
</div>
<div style="clear:both"></div>
<div itemprop="description">
                        
<p>Quero vender meu consórcio, mas não sei como fazer. Esta é uma pergunta muito frequente, e sempre respondemos. Procure uma empresa idônea e que ofereça uma avaliação justa no seu consórcio.</p>
...
<p class="conteudo"><?php echo $semantica_5;?></p>
</div>
<!-- === Fim Formulário === -->				
</div>
</div>
